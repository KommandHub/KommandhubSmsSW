...
# must never be listed; only composer-installed siblings belong here.
STATIC_COPY_PLUGINS :=
...
#
#   Could not find a version of package kommandhub/sms-sw matching your
...
PLUGIN_PACKAGE := kommandhub/sms-sw
